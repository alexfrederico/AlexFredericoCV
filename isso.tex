...
\cvtag{Análise de sentimentos}
\cvtag{Git}

\vspace{10px}

\cvevent{Forecast Sales}{Procedimento que busca fazer estimativa das vendas de uma empresa em um determinado período futuro.}{}{}
\begin{itemize}
